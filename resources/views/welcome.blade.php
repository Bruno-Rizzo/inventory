...
<body>
  ...
  <section id="topbar" class="d-flex align-items-center">
    <div class="container d-flex justify-content-center justify-content-md-between">
      <div class="contact-info d-flex align-items-center">
        <i class="bi bi-envelope d-flex align-items-center"><a href="mailto:contact@example.com">contato@inventory.com</a></i>
        <i class="bi bi-phone d-flex align-items-center ms-4"><span>+21 98765-4321</span></i>
      </div>
  ...
  <script src="{{asset('/frontend/assets/vendor/waypoints/noframework.waypoints.j')}}s"></script>
